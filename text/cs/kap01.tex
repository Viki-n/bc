...
Pro lepší porozumnění představíme případ z praxe. Nechť je pozorovatel člověk, který není
...
\begin{figure}[h!]
  ...
  \centering
\caption{Závislost hit rate a false alarm rate pro různé hodnoty $d'$. Těmto křivkám se říká ROC křivky z anglického Receiver Operating Characteristic \citep{DavidSDT}.} 
\label{obr:dprime} 
\end{figure}
...
hodoty $a$, spočítáme jako $$I(A=a)=-\log_b\left({\P{A=a}}\right)=\log_b\left(\frac1{\P{A=a}}\right).$$ Jako
