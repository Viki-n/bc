...
Funkcím, které dávají do souvislosti parametry stimulů a chování subjektu v experimentu, se říká {\it psychometrické funkce} \citep{psychophysics}. Zde je tedy parametrem poloha stimulu, a chování subjektu je vyjádřeno jeho hodnotou $d'$.
