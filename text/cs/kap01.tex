...
V teorii detekce signálu šumem nazýváme necht (a typicky neznámou) modifikaci signálu.
\index{Šum}
...
Též v případě, kdy je algoritmus ideálního pozorovatele v určitém smyslu
přirozený, apříklad nedělá žádné kontraintuitivní kroky, můžeme tvrzení
\uv{Lidský pozorovatel se chová ideálně} použít jako úodní hypotézu, kterou
